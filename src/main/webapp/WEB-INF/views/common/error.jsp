...
<%-- isErrorPage="true" : 다른 jsp 페이지의 에러를 넘겨받아서 에러 출력 처리용 페이지에 사용하는 속성 
	 반드시 표기해야 함
	 이 속성이 있어야, jsp 내장객체 중 exception 객체를 사용할 수 있음
--%>
...
<%-- jsp 내장객체 중 exception 객체 사용 : 
 ...
 --%>
<%-- <% if(exception != null){ 	// 다른 jsp 페이지에서 에러가 발생했다면 %>
...
<%-- 스프링에서는 내보낼 뷰페이지들은 모두 설정된 뷰리졸버를 거쳐서 전송되어야 함
