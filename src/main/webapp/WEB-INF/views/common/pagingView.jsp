...
<%-- url 뒤에 추가할 쿼리스트링으로 사용할 변수를 저장함 --%>
...
<div style="text-align : center;">
	...
	<%-- 현재 출력한 페이지가 속한 페이지 그룹의 페이지 숫자 출력 : 10개 --%>
	...
	<%-- 마지막 페이지로 이동 --%>
	<c:if test="${ paging.currentPage ge paging.maxPage }">	<%-- ge : greater equal, >= 연산자를 의미함 --%>
		[맨끝] &nbsp;
	</c:if>
	<c:if test="${ !(paging.currentPage ge paging.maxPage) }">	<%-- gt : greater than, > 연산자를 의미함 --%>
