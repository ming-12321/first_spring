...
public class BoardController {
	// 로그 객체 생성
	private static final Logger logger = LoggerFactory.getLogger(BoardController.class); // org.slf4j 임포트 하기
	...
	public Map<String, Object> boardNewTop3Method() {
...
//		return sendJson.toJSONString();
	...
	public ModelAndView boardDetailMethod(@RequestParam("bnum") int boardNum,
		...
		int currentPage = 1; // 상세보기 페이지에서 목록 버튼 누르면, 보고 있던 목록 페이지로 돌아가기 위해 저장함
		if (page != null) {
			currentPage = Integer.parseInt(page);
		}
